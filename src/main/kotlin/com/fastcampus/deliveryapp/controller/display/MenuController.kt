...
class MenuController(
    ...
    fun detail(
        @PathVariable menuId: Long, @RequestParam storeId: Long,
        @CookieValue(value = "customerId") customerId: Long?, @CookieValue(value = "access-token") accessToken: String?,
        model: Model
    ): String {
        logger.info { ">>> 메뉴 상세 조회, menuId: $menuId, storeId: $storeId, customerId: $customerId" }
    ...
    private fun validateStoreId(menuDetail: MenuDetailDTO, storeId: Long) {
